...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark pb-3 " style="background-color:#4E63B4;">
      <div class="container-fluid ms-4">
        <a class="navbar-brand fs-3 fw-bold" href="homepage.php">Teach Us</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav fs-5 ms-5">
            <li class="nav-item">
              <a class="nav-link me-3" aria-current="page" href="homepage.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active me-3" href="product.php">Product</a>
            </li>
            <li class="nav-item">
            ...
            ?>
            <li class="nav-item">
              <a class="nav-link me-3" href="index.php">My Class</a>
            </li>
          </ul>
        </div>
        <div class="text-light fw-bold fs-5">
          <?php
              ...
              echo $_SESSION['nama']."&nbsp; &nbsp; &nbsp;"; 
              echo "<img src='../img/face.jpeg' class='img-fluid rounded-circle' width='45px' height='auto' >";
              echo "</li>";
  ...
  <body style="background-color: #2b4292;">
    <div class="container">
      <section class="margin-section">
        <div>
        <div class="container bg-product" style="background-color: #4e63b4;">
              <div class="row pad-product-top">
                <div class="col">
                  <img src="gambar/product-japan-01.jpg" class="img-fluid picture-product" alt="as">
                </div>
              </div>
              <div class="row margin-section" style="padding-bottom: 20px;">
                <div class="col">
                  <div class="card margin-card" style="width: 100%;">
                      <img src="gambar/silver-01.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Japan Kids</h5>
                        <p class="card-text">Perdalam bahasa Jepang mu dengan paket Japan Kids</p>
                        <form action="payment.php" method="post">
                          <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="jepang_kids" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='../login.php' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
                          ?>
                        </form>
                      </div>
                ...
                <div class="col">
                  <div class="card margin-card" style="width: 100%;">
                      <img src="gambar/silver-01.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Japan Teenager</h5>
                        <p class="card-text">Perdalam bahasa Jepang mu dengan paket Japan Teenager</p>
                        <form action="payment.php" method="post">
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="jepang_teen" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='../login.php' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
                  ...
                  <div class="card margin-card" style="width: 100%;">
                      ...
                      <div class="card-body">
                        ...
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="jepang_expert" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='../login.php' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
      ...
      <section>
        <div>
        <div class="container margin-section bg-product" style="background-color: #4e63b4;">
              <div class="row pad-product-top">
                <div class="col">
                  <img src="gambar/product-english-01.jpg" class="img-fluid picture-product" alt="as">
                </div>
              </div>
              <div class="row margin-section" style="padding-bottom: 20px;">
              <div class="col">
                  <div class="card margin-card" style="width: 100%;">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">English Kids</h5>
                        <p class="card-text">Perdalam bahasa Inggris mu dengan paket English Kids</p>
                        <form action="payment.php" method="post">
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="inggris_kids" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='#' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
                          ?>                        
                          </form>                         
                      </div>
                ...
                <div class="col">
                  <div class="card margin-card" style="width: 100%;">
                      <img src="gambar/gold-01.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">English Teenager</h5>
                        <p class="card-text">Perdalam bahasa Inggris mu dengan paket English Teenager</p>
                        <form action="payment.php" method="post">
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="inggris_teen" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='#' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
                  ...
                  <div class="card margin-card" style="width: 100%;">
                      ...
                      <div class="card-body">
                        ...
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="inggris_expert" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='#' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
      ...
      <section>
        <div>
          <div class="container margin-section bg-product" style="background-color: #4e63b4;">
              <div class="row pad-product-top">
                <div class="col">
                  <img src="gambar/product-indonesian-01.jpg" class="img-fluid picture-product" alt="as">
                </div>
              </div>
              <div class="row margin-section" style="padding-bottom: 20px;">
                <div class="col">
                  <div class="card margin-card" style="width: 100%;">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Indonesian Kids</h5>
                        <p class="card-text">Perdalam bahasa Indonesia mu dengan paket Indonesian Kids</p>
                        <form action="payment.php" method="post">
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="indo_kids" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='#' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
                ...
                <div class="col">
                  <div class="card margin-card" style="width: 100%;">
                      <img src="gambar/bronze-01.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Indonesian Teenager</h5>
                        <p class="card-text">Perdalam bahasa Indonesia mu dengan paket Indonesian Teenager</p>
                        <form action="payment.php" method="post">
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="indo_teen" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='#' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
                  ...
                  <div class="card margin-card" style="width: 100%;">
                      ...
                      <div class="card-body">
                        ...
                        <?php
                            if(isset($_SESSION['nama'])){
                          ?>
                          <input type="submit" name="indo_expert" value="Beli Sekarang!" class="btn bg-button button-hover">
                          <?php
                            } else{
                              echo "<a href='#' class='btn bg-button button-hover'>Daftar Sekarang!</a>";
                            }
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-5 d-flex justify-content-center">
            <a href="homepage.php" class="font-white2 fs-5 a" style="margin: 5px;">Home</a>
