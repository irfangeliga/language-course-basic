...
$id = $_GET['id'];
$sql = "SELECT * FROM upload WHERE tujuan = '$id' and status = 'tugas' order by id DESC";
...
<html lang="en">
    ...
    <body style="background-color:#0d5e72;">  
        ...
        <div class="text-center fw-bold" style="opacity:70%;color:white;font-size:450%">
            <p>ASSIGMENT COLLECTION</p>
        </div>
        <?php
        if($row == 0){
        ?>
        <div class="alert text-center" role="alert">
            <h4 class="alert-heading ">Belum Ada Tugas di Upload</h4>
        </div>
        ...
        <div class="card mapel" >
            ...
            <div class="card-body">
            <?php
                echo "<a href='isi-task.php?id=".$siswa['id']."' class=' text-decoration-none' style='color:#0d5e72;'>";
