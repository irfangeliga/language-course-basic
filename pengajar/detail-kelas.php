                        ...
                        <li class="nav-item">
                            <?php 
                                if(isset($_SESSION['nama'])){
                                    ...
                                    echo "<img src='../img/".$siswa2['foto']."' class='img-fluid rounded-circle' width='40px' height='auto' alt='foto profil'>";
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-10" style="border:1px solid black;">
                        <div class="card-body pdf">
                            <a href="../img/<?php echo $siswa['file'] ?>" class="btn-file text-primary fw-bold fs-5 text-decoration-none" name="file"><?php echo $siswa['file'] ?></a>
                        </div>
                    </div>
                </div>
            </div>
