      ...
      <div class="container-fluid ms-4">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav fs-5 ms-5">
            ...
            <li class="nav-item">
              <a class="nav-link active me-3" href="about.php">About</a>
            </li>
            <li class="nav-item">
...
<!-- <section>
  ...
  <div class="container-fluid">
    ...
    <section>
    <h1 class="font-white" style="margin-top: 50px"> Apa itu Teach Us?</h1>
    <hr style="color: white; height: 5px">
    <p class="font-white3">Teach Us adalah start-up pengajaran yang terbuka untuk umum dan berbasis web.</p>
    <p class="font-white3">Proses belajar mengajar dilakukan secara online di dalam web Teach Us itu sendiri.</p>
    <p class="font-white3">Program pembelajaran Teach Us masih bisa dikembangkan lagi, jadi masih banyak peluang pembelajaran baru yang bisa ditambahkan ke dalam program Teach Us</p>
    </section>
    <section>
    <h1 class="font-white" style="margin-top: 50px"> Siapa Pembuat Teach Us?</h1>
    <hr style="color: white; height: 5px">
    <p class="font-white3">Teach Us adalah hasil karya Final Project dari mahasiswa Universitas Amikom Yogyakarta. </p>
    <p class="font-white3">Berawal dari Final Project berkelompok yang beranggotakan 2 orang, kemudian dikembangkan menjadi wadah pembelajaran yang berskala besar.</p>
    </section>
    <section>
    <h1 class="font-white" style="margin-top: 50px"> Kapan Teach Us diciptakan?</h1>
    <hr style="color: white; height: 5px">
    <p class="font-white3">Teach Us mulai dikembangkan besar-besaran pada tanggal 1 Januari 2022</p>
    <p class="font-white3">Kemudian mulai dipublikasikan secara resmi pada tanggal 20 Januari 2022</p>
    </section>
    <section>
    <h1 class="font-white" style="margin-top: 50px"> Kenapa Teach Us dibuat?</h1>
    <hr style="color: white; height: 5px">
    <p class="font-white3">Tujuan pertama, sudah jelas, FINAL PROJECT.</p>
    <p class="font-white3">Tujuan kedua, yaitu untuk membuatkan wadah pembelajaran untuk masyarakat umum.</p>
    <p class="font-white3">Tujuan ketiga, dapat duit kalo bisa.</p>
    </section>
    <section>
    <h1 class="font-white" style="margin-top: 50px"> Dimana Kantor Utama Teach Us?</h1>
    <hr style="color: white; height: 5px">
    <p class="font-white3">Project Teach Us diciptakan di kota Yogyakarta, terutama di kampus Amikom Yogyakarta</p>
    <p class="font-white3">Kemudian berkembang dan menetap di kantor Cyber Gold Jl. Gold Miner II</p>
    </section>
    </div>
